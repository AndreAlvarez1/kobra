class PagesController < ApplicationController
  ...
  def dashboard
    ...
    @ranking = @buyer.ranking_sales_between_dates(@search.date_from, @search.date_to, @seller)
    @names = []
    @values = []
