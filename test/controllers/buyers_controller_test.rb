...
class BuyersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create buyer" do
    assert_difference('Buyer.count') do
      post buyers_url, params: { buyer: { detail: @buyer.detail, email: @buyer.email, first_name: @buyer.first_name, last_name: @buyer.last_name, phone: @buyer.phone, photo: @buyer.photo, seller_id: @buyer.seller_id } }
    end
  ...
  test "should update buyer" do
    patch buyer_url(@buyer), params: { buyer: { detail: @buyer.detail, email: @buyer.email, first_name: @buyer.first_name, last_name: @buyer.last_name, phone: @buyer.phone, photo: @buyer.photo, seller_id: @buyer.seller_id } }
